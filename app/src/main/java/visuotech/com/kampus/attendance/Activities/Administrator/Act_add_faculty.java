...
public class Act_add_faculty extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final View rowView = inflater.inflate(R.layout.content_main_add_faculty, null);
...
//        spinner_prefix.setAdapter(adapter_prefix);
        ...
        tv_dob.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                datePickerDialog = new DatePickerDialog(Act_add_faculty.this,
    ...
    public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
        switch(adapterView.getId()){
               case R.id.spinner_course :
                   ...
                   courseId=course_list1.get(i).getCourse_id();
                   department_list.clear();
                   ApigetDepartment();
//                 Toast.makeText(getApplicationContext(),director, Toast.LENGTH_LONG).show();
                break;
...
//        RequestBody cover_pic_ = RequestBody.create(MediaType.parse("text/plain"), String.valueOf(mainBitmap));
        ...
        RequestBody courseId_ = RequestBody.create(MediaType.parse("text/plain"), courseId);
    ...
    private void selectImage() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(Act_add_faculty.this);
        ...
        switch (requestCode) {
            case REQ_CODE_Gallery: {
                try {
                    ...
                    mainBitmap = MediaStore.Images.Media.getBitmap(Act_add_faculty.this.getContentResolver(), selectedImage);
...
//                    iv_profile_camera.setVisibility(View.GONE);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        Intent i = new Intent(Act_add_faculty.this, Act_faculty_list.class);
        startActivity(i);
        finish();
        return true;
