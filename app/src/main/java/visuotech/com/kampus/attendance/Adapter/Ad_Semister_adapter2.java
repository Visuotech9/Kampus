...
public class Ad_Semister_adapter2 extends RecyclerView.Adapter<Ad_Semister_adapter2.MyViewHolder> {
    ...
    public Ad_Semister_adapter2(Context context, ArrayList<SemList> list, TextView tv_station1, TextView tv_select_all, CheckBox checkbox_all, String con) {
        this.list = list;
