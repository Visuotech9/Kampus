...
public class Ad_director extends RecyclerView.Adapter<Ad_director.MyViewHolder> {
    ArrayList<Director> list;
    Context context;

    public Ad_director (ArrayList<Director> list, Context context) {
        this.list = list;
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view= LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.list_director,viewGroup,false);
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, final int i) {
        ...
        holder.tv_name.setText(list.get(i).getDirector_name());
...
*/
    ...
    public void filterList(ArrayList<Director> director_list2) {
