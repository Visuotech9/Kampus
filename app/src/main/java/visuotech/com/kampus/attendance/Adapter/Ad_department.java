...
public class Ad_department extends RecyclerView.Adapter<Ad_department.MyViewHolder> {
    ArrayList<Department> list;
    Context context;

    public Ad_department (ArrayList<Department> list, Context context) {
        this.list = list;
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, final int i) {
        ...
        holder.tv_name.setText(list.get(i).getDepartment_name());
...
//            tv_id =  itemView.findViewById(R.id.tv_id);
    ...
    public void filterList(ArrayList<Department> dept_list2) {
        this.list = dept_list2;
