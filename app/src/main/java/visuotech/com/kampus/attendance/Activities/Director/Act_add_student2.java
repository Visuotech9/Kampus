...
public class Act_add_student2 extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_act_add_student2);
        //-------------------------toolbar------------------------------------------
...
//        RequestBody cover_pic_ = RequestBody.create(MediaType.parse("text/plain"), String.valueOf(mainBitmap));
    ...
    private void ApigetSemister(){
        ...
        String remainingUrl2="/Kampus/Api2.php?apicall=sem_list&organization_id="+organization_id+"&course_id="+sessionParam.course_id;
        baseRequest.callAPIGETData(1, remainingUrl2);
    }
...
//
        ...
        String remainingUrl2="/Kampus/Api2.php?apicall=section_list&organization_id="+organization_id+"&course_id="+sessionParam.course_id+"&department_id="+dept_id;
        baseRequest.callAPIGETData(1, remainingUrl2);
    }
