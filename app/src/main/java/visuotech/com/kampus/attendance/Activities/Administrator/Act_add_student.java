...
//        iv_cal_doj = rowView.findViewById(R.id.iv_cal_doj);
        ...
        spinner_scholarship = findViewById(R.id.spinner_scholarship);
        ...
        tv_dob.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                datePickerDialog = new DatePickerDialog(Act_add_student.this,
...
//                datePickerDialog.getDatePicker().setMinDate(System.currentTimeMillis()-1000);
        ...
        tv_doa.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                calendar = Calendar.getInstance();
                year = calendar.get(Calendar.YEAR);
...
//
    ...
    private void selectImage() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(Act_add_student.this);
        ...
        switch (requestCode) {
            case REQ_CODE_Gallery: {
                try {
                    ...
                    mainBitmap = MediaStore.Images.Media.getBitmap(Act_add_student.this.getContentResolver(), selectedImage);
...
//                    iv_profile_camera.setVisibility(View.GONE);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        Intent i = new Intent(Act_add_student.this, Act_student_list.class);
        startActivity(i);
        finish();
        return true;
