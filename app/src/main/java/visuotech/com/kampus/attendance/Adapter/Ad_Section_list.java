...
public class Ad_Section_list extends RecyclerView.Adapter<Ad_Section_list.MyViewHolder> {
    ...
    public Ad_Section_list(ArrayList<Section> list, Context context, String dept_name) {
        this.list = list;
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, final int i) {
        int j=i+1;
        holder.tv_station.setText(list.get(i).getSection());
...
//        });
    ...
    public void filterList(ArrayList<Section> list) {
        this.list = list;
